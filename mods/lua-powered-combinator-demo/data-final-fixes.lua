local search_n_replace = {
    ...
    '__lua-powered-combinator-demo__/graphics/icons/lua-combinator.png',
    ['__base__/graphics/entity/combinator/decider-combinator.png'] =
    '__lua-powered-combinator-demo__/graphics/entity/combinator/lua-combinator.png',
    ['__base__/graphics/entity/combinator/hr-decider-combinator.png'] =
    '__lua-powered-combinator-demo__/graphics/entity/combinator/hr-lua-combinator.png',
}
